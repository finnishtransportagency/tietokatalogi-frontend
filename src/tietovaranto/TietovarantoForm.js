...
export class TietovarantoForm extends React.Component {
  render() {
    ...
    const {
      toimintaprosessi: toimintaprosessiIds = [],
      organisaatio: organisaatioIds = [],
    } = resources ? resources : {};
          ...
          <form onSubmit={formApi.submitForm}>
            ...
            >
              ...
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="vastaava" className="row">
                      Vastuutaho
                    </label>
                    <div className="row">
                      <Text
            ...
            <Collapse
              header={"Tiedot henkilötietojen käsittelystä"}
              isOpened={true}
            >
              ...
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="yllapito_muut_tahot" className="row">
                      Käsittelyyn osallistuvat tahot, kuten henkilötietojen
                      käsittelijät
                    </label>
                    <div className="row">
                      <CreatableCustomMultiselect
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label
                      htmlFor="viittaus_henktieto_sopimukseen"
                      className="row"
                    >
                      Viittaus solmittuun henkilötietojen käsittelyä koskevaan
                      sopimukseen
                    </label>
                    <p className="row">
                      Viittaus (mahdolliseen) henkilötietojen käsittelijän
                      kanssa solmittuun henkilötietojen käsittelyä koskevaan
                      sopimukseen
                    </p>
                    <div className="row">
                      <Text
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label
                      htmlFor="tekniset_org_turvatoimenpiteet"
                      className="row"
                    >
              ...
              <h4>
                Henkilötietojen siirto EU/ETA-alueen ulkopuolelle tai
              ...
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label
                      htmlFor="kolmannet_maat_ja_jarjestot"
                      className="row"
                    >
                      Kolmannet maat ja kansainväliset järjestöt
                    </label>
                    <p className="row">
                      Kolmannet maat ja kansainväliset järjestöt, joihin tietoja
                      siirretään tai tieto siitä, ettei henkilötietoja siirretä
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    ...
                    <p className="row">
                      Asianmukaisia suojatoimia koskeva dokumentaatio, jos
                      henkilötietoja siirretään kolmansiin maihin tai
                      kansainvälisiin järjestöihin tietosuoja-asetuksen 49
                      artiklan 1 kohdan toisessa alakohdassa tarkoitetulla
                      siirrolla
                    </p>
                    <div className="row">
                      <Text
