...
import { FormControls, validateAll, validateNotEmptyNumber } from "../form/FormControls";
...
export class TietoOmaisuusForm extends React.Component {
    ...
    render() {
        ...
        const fieldDisplayNames = [
            "Tiedon ensisijainen käyttötarve", "Toissijaiset käyttötarpeet", "Asiakkaat / Käyttäjät",
            "Tiedon mallinnustapa","Käyttöformaatit", "Historiatiedot", "Kattavuus ja laatu", "Metatiedot",
            "Muutostiedot", "Saatavuus", "Henkilötiedot", "Eheys", "Avoimuus", "Immateriaalioikeudet", "Yksilöivät tunnisteet",
            "Tiedon pysyvyys: Staattisuus / dynaamisuus", "Dokumentaatio", "Elinkaari", "Alustojen tyyppi ja sijainti"
        ];

        const fieldIDNames = [
            "primaarikayttotarve", "sekundaar_kayttotarpeet", "kayttajat",
            "mallinnustapa", "kayttoformaatit", "historiatiedot", "kattavuus_ja_laatu", "metatiedot",
            "muutostiedot", "saatavuus", "henkilotiedot", "eheys", "avoimuus", "immateriaalioikeudet", "yksiloivat_tunnisteet",
            "pysyvyys", "dokumentaatio", "elinkaari", "alustojen_tyyp_ja_sij"
        ];
                ...
                {formApi => (
                    <form onSubmit={formApi.submitForm}>
                        ...
                        >
                            ...
                            {Array(nFullRows).fill(null).map((_, i) => (
