...
export class CustomCollapse extends React.Component {
    ...
    openWithDelay() {
        ...
        this.openTimer = setTimeout(() => this.setState({ isFullyOpen: true }), 1000);
    }
    ...
    toggle() {
        ...
        this.setState({ isOpen: !this.state.isOpen, isFullyOpen: !this.state.isOpen });
    ...
    componentWillReceiveProps(nextProps) {
        ...
        this.setState({ isOpen: nextProps.isOpened, isFullyOpen: nextProps.isOpened });
        clearTimeout(this.openTimer);
    }
        ...
        return (
            <div className="panel panel-default">
                ...
                <Collapse 
                    ...
                    style={(this.props.edit && this.state.isFullyOpen) ? {"overflow": "visible"}: {}}
                >
