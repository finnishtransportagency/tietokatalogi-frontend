...
import { roleIdToRooliDescription, Roles, internalOrganisation } from "../utils";
...
export function validateVastaava(values) {
    ...
    if (!values.omistava_organisaatio || values.omistava_organisaatio !== internalOrganisation) {
...
export class FormControls extends Component {
    ...
    render() {
        ...
        const bottomControl = inline ? "" : "form-controls float-bottom col-xs-12 col-sm-8 col-sm-offset-4 col-md-9 col-md-offset-3 col-lg-10 col-lg-offset-2";
        return (
                    ...
                    !values.tunnus && (
                        <div className="btn-toolbar">
                            <button
                                ...
                                title={isNoModificationRights ? "Muokkausoikeudet puuttuvat" : null}
                            >
                                Luo
                            </button>
