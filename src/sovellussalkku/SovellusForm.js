...
export class SovellusForm extends HenkiloRooli {
  ...
  preSubmit(values) {
    const henkiloRooliList = values.henkiloRooliList.filter(
      (henkiloRooli) =>
        henkiloRooli !== null &&
  ...
  render() {
    const { edit, onSubmit, remove, setEditable, cancelNew, values } =
      this.props;
      ...
      >
        {(formApi) => (
          <form onSubmit={formApi.submitForm}>
            <Collapse header={`Yleiset: ${values.nimi || ""}`} isOpened={true}>
              <div className="form-group row">
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="aliasNimet" className="row">
                      Aliakset
                    </label>
                    <div className="row">
                      <TextArea
              ...
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="valmistaja" className="row">
                      Valmistaja
                    </label>
                    <div className="row">
                      <Text
                ...
                <div className="col-sm-3">
                  <div className="col-sm-12">
                    <label htmlFor="konfiguraatioVersio" className="row">
                      KonfiguraatioVersio
                    </label>
                    <div className="row">
                      <Text
              ...
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="kayttojarjestelmavaatimus" className="row">
                ...
                <div className="col-sm-3">
                  <div className="col-sm-12">
                    <label htmlFor="arkkitehtuuri" className="row">
                      Arkkitehtuuri
                    </label>
                    <div className="row">
                      <Text
              ...
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="sovelluksenTyyppi" className="row">
                      Sovelluksen tyyppi
                    </label>
                    <div className="row">
                      <Text
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="kielisyys" className="row">
                      Kielisyys
                    </label>
                    <div className="row">
                      <Text
              ...
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="lisatietoja" className="row">
                      Lisätietoja
                    </label>
                    <div className="row">
                      <TextArea
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="tuotekoodi" className="row">
                      Tuotekoodi
                    </label>
                    <div className="row">
                      <TextArea
            ...
            <Collapse header={"Asennus"} isOpened={true}>
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="riippuvuustieto" className="row">
                      Riippuvuustieto
                    </label>
                    <div className="row">
                      <Text
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="liittymatJarjestelmiin" className="row">
                ...
                {Object.keys(roleToRolepersonList).map((roleId) => {
                  ...
                  return (
                    <div className="col-sm-6" key={roleId}>
                      <div className="col-sm-12">
                        <label htmlFor="sovellusomistaja" className="row">
            ...
            <Collapse header={"Muuta"} isOpened={true}>
              <div className="form-group row">
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="tuotantoonHyvaksymispaiva" className="row">
                ...
                <div className="col-sm-6">
                  <div className="col-sm-12">
                    <label htmlFor="kriittisyys" className="row">
                      Kriittisyys
                    </label>
                    <div className="row">
                      <Text
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  <div className="col-sm-12">
                    <label htmlFor="elinkaaritieto" className="row">
                      Elinkaaritieto
                    </label>
                    <div className="row">
                      <TextArea
