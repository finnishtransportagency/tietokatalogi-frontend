...
import {FormControls, validate, validateAll, validateNotEmpty, validateVastaava} from "../form/FormControls";
...
import { getReversedLink, convertLinksFromMultiselectToSendableFormat } from "./JarjestelmaLinkUtils";
    ...
    render() {
        ...
        if (values.noRightsToModify) {
            disabled = {
                tietoturvasopimus:
                    !edit ||
                    values.noRightsToModify.includes("tietoturvasopimus")
            };
        }
        if (values.tunnus) {
        ...
        return (
            <Form
                validateError={values => {
                    return validateAll(values, validate, validateLinkList, validateNotEmpty(["omistava_organisaatio"]), validateVastaava);
                }}
                onSubmit={values => {
                    if (values && values.noRightsToModify) {
                        if (values.noRightsToModify.includes("ALL_FIELDS"))
                            return this.props.onSubmit({});
                        values.noRightsToModify.forEach(
                            field => delete values[field]);
                    }
                    ...
                    if (values.jarjestelmaLinkkausListMultiselect) {
                        const sendFormatValues = convertLinksFromMultiselectToSendableFormat(
                            values.jarjestelmaLinkkausListMultiselect, values.jarjestelmaLinkkausMetadata || {}
                        );
                        ...
                        >
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="toimittajan_yhteyshenkilo"
                                            className="row"
                                        >
                            ...
                            <div className="form-group row">
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="kayttopalvelun_toimittaja"
                                            className="row"
                                        >
                        ...
                        <Collapse header={"Tietoturva"} isOpened={true} edit={edit}>
                            <div className="form-group row">
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="liik_turvallisuusluokka"
                                            className="row"
                                        >
                            ...
                            <div className="form-group row">
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="tietoturvatasoluokitus"
                                            className="row"
                                        >
                            ...
                            <div className="form-group row">
                                ...
                                */}
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="sla_luokitus_kayttopalvelu"
                                            className="row"
                                        >
                                            SLA luokitus
                                        </label>
                                ...
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            ...
                                            className="row"
                                        >
                                            Luokituksen tarkastuspäivämäärä
                                            (pp.kk.vvvv)
                                        </label>
                                        <div className="row">
                                            <CustomDatePicker
                            ...
                            <div className="form-group row">
                                <div className="col-sm-6">
                                    <div className="col-sm-12">
                                        <label
                                            htmlFor="tarvitaan_viikonloppuna"
                                            className="row"
                                        >
                        ...
                        <Collapse
                            ...
                            isOpened={
                                (values.jarjestelmaLinkkausListMultiselect &&
                                    values.jarjestelmaLinkkausListMultiselect.length >
                                    0) ||
                                edit
                            }
                            edit={edit}
